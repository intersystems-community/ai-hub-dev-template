...
| SyntheticDataGen       | Tool for generating 4 different configurable synthetic datasets (5-10 linked tables) covering finance, supplychain, retail and a themepark | `zpm "install iris-synthetic-data-gen"` and follow instructions in link                                                                               |                                                                                 |
